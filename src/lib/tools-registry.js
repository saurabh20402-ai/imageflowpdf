...
export const TOOLS = [
  // === PDF TOOLS ===
  {
    slug: 'merge-pdf',
    name: 'Merge PDF',
    description: 'Combine multiple PDFs into a single file — reorder by file order.',
    category: 'pdf',
    color: '#ef4444',
    icon: 'Files',
  ...
  },
  {
    slug: 'split-pdf',
    name: 'Split PDF',
    description: 'Extract selected pages into a new PDF (e.g. 1-3,5,7).',
    category: 'pdf',
    color: '#f97316',
    icon: 'Scissors',
  ...
  },
  {
    slug: 'compress-pdf',
    name: 'Compress PDF',
    description: 'Reduce PDF size (best for scanned PDFs) — works in your browser.',
    category: 'pdf',
    color: '#eab308',
    icon: 'Zap',
  ...
  },
  {
    slug: 'watermark-pdf',
    name: 'Watermark PDF',
    description: 'Add a text watermark on top of your PDF pages.',
    category: 'pdf',
    color: '#8b5cf6',
    icon: 'Stamp',
  ...
  },
  {
    slug: 'sign-pdf',
    name: 'Sign PDF',
    description: 'Draw or upload a signature and apply it to your PDF.',
    category: 'pdf',
    color: '#22c55e',
    icon: 'PenTool',
  ...
  },
  {
    slug: 'webp-to-png',
    name: 'WebP to PNG',
    description: 'Convert WebP images to PNG (lossless, transparency preserved).',
    category: 'convert',
    color: '#db2777',
    icon: 'FileImage',
    component: 'FormatConverter',
  ...
  },
  {
    ...
    description: 'Remove a solid-color background (best for studio/product photos).',
    category: 'transform',
    color: '#3b82f6',
    icon: 'Eraser',
  ...
  },
  {
    slug: 'image-upscaler',
    name: 'Image Upscaler',
    description: 'Upscale images 2× or 4× (non‑AI) with high-quality smoothing.',
    category: 'transform',
    color: '#14b8a6',
    icon: 'Maximize2',
  ...
  },
  {
    ...
    description: 'Create passport-size photos with country presets (35×45mm, 2×2in).',
    category: 'transform',
    color: '#0ea5e9',
    icon: 'IdCard',
  ...
  },
  {
    ...
    description: 'Batch convert images to WebP/JPG/PNG and download as ZIP.',
    category: 'create',
    color: '#ea580c',
    icon: 'Package',
