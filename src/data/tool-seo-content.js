...
export const TOOL_SEO_CONTENT = {
  "jpg-to-png": {
    ...
    "subtitle": "Transform your JPEG images to transparent PNG files locally. **secure and client-side.**",
    ...
    "faqs": [
      {
        ...
        "a": "No, all conversions happen locally in your web browser. Your files are secure and client-side and never leave your device."
      },
      {
  ...
  "png-to-jpg": {
    ...
    "subtitle": "Compress and convert your PNG files to JPGformat locally. **secure and client-side.**",
  ...
  "heic-converter": {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": "No. The entire conversion process occurs locally in your browser, guaranteeing your photos are processed locally or stored."
      },
      {
  ...
  "merge-pdf": {
    ...
    "introduction": "Merging multiple PDF documents into a single organized file simplifies document management, streamlines sharing, and keeps related paperwork in one convenient place. Whether you are assembling a job application with your resume, cover letter, and reference letters, compiling monthly invoices for accounting, or combining academic project chapters, this free online PDF merger provides a fast, straightforward solution to combine PDF files. Unlike traditional online converters that transfer documents to remote web servers, ImageFlow lets you merge PDF files directly inside your web browser using client-side processing. This architecture means your files remain securely on your device throughout the entire operation. Using our interactive interface, you can drag and drop multiple PDFs, arrange them in the exact page sequence you need, and combine PDF into one file ready for immediate download. The tool preserves your original document layout, vector shapes, typography, and visual quality so the final merged document remains crisp and readable. Because processing runs locally on your computer, you can merge PDF online free without upload delays, file size queues, or mandatory account registrations, giving you a privacy-conscious way to handle your documents.",
    "useCases": {
      ...
      "items": [
        {
          ...
          "description": "Combine your resume, cover letter, and certificates into a single PDF."
        },
        {
          "icon": "GraduationCap",
          "title": "Academic Submissions",
          "description": "Merge multiple chapters or assignment sheets into one file."
        },
        {
          "icon": "Calculator",
          "title": "Financial Records",
          "description": "Group all monthly receipts, invoices, or statements together."
        }
      ]
    },
    "steps": {
      "title": "How to Merge PDF Files in 4 Steps",
      "items": [
        {
          "title": "Upload",
          "description": "Click \"Choose Files\" or drag-and-drop your PDFs into the tool."
        },
        {
          "title": "Reorder",
          "description": "Drag the file cards to arrange them in the correct sequence."
        },
        {
          "title": "Merge",
          "description": "Click the \"Merge PDFs\" button. The tool merges them locally."
        },
        {
          "title": "Download",
          "description": "Save your combined PDF instantly to your device."
        }
      ]
    },
    "faqs": [
    ...
    "faqs": [
      {
        ...
        "a": "Absolutely. Processing is fully local, so your files are processed locally to our servers."
      },
      {
  ...
  "rotate-pdf": {
    ...
    "subtitle": "Turn and rotate PDF pages easily. **secure and client-side.**",
    "introduction": "Have you ever opened a scanned document only to find that some or all of the pages are upside down or sideways? The ImageFlow Rotate PDF tool offers a quick and effortless way to correct the orientation of your documents, ensuring they are perfectly readable and professionally presented. Whether you are dealing with improperly scanned legal contracts, landscape charts that ended up in portrait mode, or architectural blueprints that need adjustment, our tool gives you full control. Just like all tools in the ImageFlow suite, our PDF rotator is built with absolute security and privacy in mind. We utilize advanced in-browser processing technology, which means your files are modified locally on your own computer. You never have to upload your sensitive documents to a remote server, making the entire process secure and client-side and private. Your proprietary business information, personal identification documents, and confidential records never leave your device. Because the processing is completely local, you will also experience immediate results without waiting for files to upload or download. The intuitive interface allows you to rotate individual pages or the entire document with just a few clicks. Fix your document orientation instantly and maintain complete peace of mind knowing that your privacy is fully protected. Achieve perfect alignment for all your important files with our lightning-fast, upload-free PDF rotation tool.",
    "useCases": {
    ...
    "faqs": [
      {
        ...
        "a": "No, our tool is fully local. Your sensitive documents and signature data never leave your computer."
      },
      {
    ...
    "faqs": [
      {
        ...
        "a": "No, all processing happens locally in your browser. Your files are processed locally, ensuring complete privacy control."
      },
      {
  ...
  "batch-resize": {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": "very safe. All resizing occurs locally on your machine. We never see or store your files."
      },
      {
  ...
  "collage-maker": {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": "Yes. Because the collage is generated entirely locally in your browser, your photos are processed locally or stored."
      },
      {
  ...
  "merge-images": {
    ...
    "subtitle": "Seamlessly join multiple pictures together. **secure and client-side.**",
    "introduction": "There are countless scenarios where you need to combine several separate pictures into one continuous graphic. Our online image merger is the perfect utility for seamlessly stitching photos together, whether vertically or horizontally. This tool is exceptionally useful for creating long scrolling infographics, assembling panoramic landscape shots, or combining multiple screenshots into a single, easily readable document. Designed with simplicity and speed in mind, you can effortlessly align your images, adjust the canvas background, and export a unified file in seconds. The most critical feature of this image joining tool is its absolute commitment to your privacy. Utilizing state-of-the-art client-side processing, the entire merging operation takes place locally within your web browser. This means there is zero server upload involved. Your confidential financial screenshots, private chat histories, or proprietary design mockups are never transmitted across the internet, ensuring enhanced data security. Avoid the steep learning curve of complex desktop software and the privacy risks of cloud-based applications. Quickly append images top-to-bottom or side-by-side, perfectly tailored to your exact needs, completely free and securely on your own device.",
    "useCases": {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": "Absolutely. Because the tool runs locally in your browser, your personal screenshots are processed locally anywhere."
      },
      {
    ...
    "faqs": [
      {
        ...
        "a": "No, all resizing happens locally in your web browser. Your images are processed locally, ensuring complete privacy control."
      },
      {
  ...
  "rotate-image": {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": "Absolutely. Since no files are uploaded to any server, your images are secure and client-side."
      },
      {
  ...
  "image-upscaler": {
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": "Yes, our local image upscaler is completely free with no hidden fees or subscriptions."
      },
      {
